            ...
            <div class="card card-body text-center shadow-lg">
                <form action="signup.php" method="POST">
                    ...
                    <div class="form-group m-2">
                        <input type="email" name="email" class="form-control" placeholder="Email" autofocus required value="<?php echo $emailValue; ?>">
                    </div>
                    <div class="form-group m-2">
                        <input type="password" name="password" class="form-control" placeholder="Contraseña" required value="<?php echo $passwordValue; ?>">
                    </div>
                    <div class="form-group m-2">
                        <input type="password" name="confirm_password" class="form-control" placeholder="Confirme su Contraseña" required value="<?php echo $confirmPasswordValue; ?>">
                    </div>
                    <div class="form-group m-2">
                        <input type="text" name="name" class="form-control" placeholder="Nombre y Apellido" required value="<?php echo $nameValue; ?>">
                    </div>
                    <?php
                    ...
                    <div class="form-group m-2">
                        <select name="career_id" class="form-control" required>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result_career)) { ?>
                                <option value="<?php echo $row['career_id']; ?>" <?php if ($row['career_id'] == $careerIdValue) echo 'selected'; ?>>
                                    <?php echo $row['name']; ?>
                                </option>
                            <?php } ?>
                        </select>
                    ...
                    <?php endif; ?>
                    <br>
                    <input type="submit" class="btn btn-success btn-block mx-auto d-block" name="signup" value="Registrarse">
                </form>
            </div>
        </div>
    </div>
